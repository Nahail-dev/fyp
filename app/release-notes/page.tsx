...
const releases = [
  ...
  },
  {
    ...
    changes: [
      ...
      'Added Privacy Policy, Terms of Service, and Release Notes pages.',
    ],
  },
  {
    number: 'Release 07',
      ...
      <section className="border-b border-border bg-card px-6 py-12 md:px-12">
        <div className="mx-auto max-w-5xl space-y-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-4xl font-serif font-bold text-foreground">Release Notes</h1>
          </div>
          <p className="max-w-3xl text-muted-foreground">
            A developer-maintained record of Yuubin releases, feature additions, and completed project milestones.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-12 md:px-12">
        <div className="mx-auto max-w-5xl space-y-6">
          {releases.map((release) => (
            <article key={release.number} className="postal-card p-6">
